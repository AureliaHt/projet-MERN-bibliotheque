        ...
        <section>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <p id="pwdnote" className={passwordFocus && !validPassword ? "instructions" : "offscreen"}>
                    ...
                    Doit contenir au moins une lettre majuscule, une lettre minuscule, un nombre et un caractère spécial. <br/>
                    Caractères acceptés : <span aria-label="point d'exclamation">!</span>
